...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full">
      {/* Top strip */}
      <div className="bg-[#544997] flex items-center justify-between px-5 md:px-10 lg:px-[60px] py-[10px] w-full">
      ...
      {/* Main bar */}
      <div className="bg-white flex items-center justify-between gap-4 px-5 md:px-10 lg:px-[60px] py-[14px] lg:py-[18px] w-full">
      ...
      {/* Menu bar (desktop) */}
      <div className="hidden lg:flex bg-white border-[#e1e2ea] border-t items-center justify-between pt-[6px] px-[60px] w-full">
      ...
      {/* Mobile drawer */}
      <div
        className={`lg:hidden overflow-hidden bg-white border-t border-[#e1e2ea] transition-[max-height,opacity] duration-300 ease-out ${
          open ? "max-h-[520px] opacity-100" : "max-h-0 opacity-0"
        }`}
      >
        <div className="px-5 md:px-10 py-5 flex flex-col gap-4">
